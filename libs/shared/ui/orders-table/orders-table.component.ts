      ...
      <table class="w-full border-separate border-spacing-y-2">
        ...
        <tbody>
          @for (order of orders; track order.id) {
            <tr class="group bg-white dark:bg-zinc-900/40 hover:bg-zinc-50 dark:hover:bg-zinc-800/60 transition-all rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800 shadow-sm">
              ...
              <td *ngIf="!hideDelivery" class="px-6 py-5 border-y border-transparent group-hover:border-zinc-200 dark:group-hover:border-zinc-700">
                <div class="flex flex-col">
                  <span class="text-xs font-bold text-zinc-900 dark:text-zinc-50">
              ...
              <td *ngIf="!hideFinancials" class="px-6 py-5 text-right border-y border-transparent group-hover:border-zinc-200 dark:group-hover:border-zinc-700">
                <span [class]="'text-sm font-black tracking-tighter ' + (getBalance(order) > 0 ? 'text-rose-500' : 'text-emerald-500')">
