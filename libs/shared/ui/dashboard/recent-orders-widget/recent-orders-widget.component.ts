  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-center pt-2">
         <button class="px-12 py-4 rounded-full border border-zinc-100 dark:border-zinc-800 text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-900 hover:text-primary transition-all active:scale-95">
           Cargar más pedidos
         </button>
      </div>
    </div>
