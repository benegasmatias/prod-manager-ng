...
import { LucideAngularModule, Tag, Package, Info, AlertCircle } from 'lucide-angular';
              ...
              <div class="flex items-start gap-4">
                ...
                <div class="space-y-1">
                  ...
                  <div class="flex flex-wrap gap-2 pt-1">
                    ...
                    @if (item.metadata?.['medidas']) {
                      <span class="text-[9px] font-black uppercase tracking-widest px-2.5 py-1 bg-zinc-100 dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 text-zinc-500">
                        Medidas: {{ item.metadata?.['medidas'] }}
                      </span>
                    }
                  </div>
                </div>
