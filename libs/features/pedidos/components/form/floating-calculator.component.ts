...
@Component({
  ...
  template: `
    ...
    @if (isOpen()) {
      <div 
        class="fixed bottom-24 sm:bottom-44 right-4 sm:right-8 w-[calc(100vw-2rem)] sm:w-72 rounded-[2rem] bg-white dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 shadow-2xl shadow-primary/20 p-2 z-[120] flex flex-col gap-1 animate-in slide-in-from-bottom-5 zoom-in-95 duration-200"
      >
    ...
    <button 
      ...
      [class]="cn(
        'fixed bottom-6 sm:bottom-24 right-4 sm:right-8 h-12 w-12 sm:h-14 sm:w-14 rounded-full shadow-2xl flex items-center justify-center transition-all z-[110] active:scale-90',
